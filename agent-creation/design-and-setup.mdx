...
<CardGroup cols={2}>
  <Card title="Language Code:" icon="language">
     Glowstudio uses [ISO 639-1 language codes](https://en.wikipedia.org/wiki/List_of_ISO_639_language_codes) to set the language, this means your widget can have literally **any** language.
    

    <Accordion title="Example:"> English will be `en`.</Accordion>
  </Card>
  <Card title="Automatic Translation:" icon="globe">
     Labels and placeholders will be **automatically** translated to your chosen language. `Title` and `branding` will keep their original language and text. Change those to your preferred language manually.
  </Card>
</CardGroup>
...
It's essential to know how the agent behaves and looks before launching on your website or letting a client test it. Glowstudio has two options for testing, right from the agent designer:
