...
<CardGroup cols={2}>
  ...
  <Card title="Augmented Generation" icon="wand-magic-sparkles">
    Uses the retrieved information to generate precise and contextually accurate responses using one of the LLMs available in Glowstudio.
  </Card>
</CardGroup>
...
>The knoweldge base interface in glowstudio
...
<CardGroup cols={2}>
  <Card title="Adding data" icon="file-circle-plus" href="/agent-creation/knowledgebase/adding-data">
    
  </Card>

  <Card title="Adjusting KB settings" icon="gear">
    
  </Card>
  
  <Card title="Structuring KB documents" icon="file">
    
  </Card>

  <Card title="KB and UI-engine" icon="window">
