...
Now that you know the proper formatting, read our comprehensive guide on how to write your [system prompt](https://docs.glowstudio.ai/agent-creation/system-prompt/step-1-define-the-tone-and-objective).
